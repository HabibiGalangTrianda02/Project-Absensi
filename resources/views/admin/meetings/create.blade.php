                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('meetings.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="meeting_date" id="meeting_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('meeting_date') border-red-500 @enderror" value="{{ old('meeting_date') }}" required>
                            @error('meeting_date')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
