            ...
            <div class="flex justify-between h-16">
                <div class="flex-shrink-0 flex items-center">
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e(asset('images/(PKU) Sultan Syarif Kasim II.png')); ?>" alt="Logo Injourney" class="block h-[95px] w-auto" />
                    </a>
                </div>
                <div class="flex items-center">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-gray-700 hover:text-indigo-600">Admin Login</a>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <li>
                            <div class="px-4 py-4 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <p class="text-lg font-semibold text-indigo-600 truncate"><?php echo e($meeting->title); ?></p>
                                    <div class="ml-2 flex-shrink-0 flex">
                                        <a href="<?php echo e(route('attendance.create', $meeting->slug)); ?>" class="px-3 py-1.5 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
                                            Isi Absensi
                                        </a>
                                    </div>
                                </div>
                                <div class="mt-2 sm:flex sm:justify-between">
                                    <div class="sm:flex">
                                        <p class="flex items-center text-sm text-gray-500">
                                            ...
                                            <?php echo e(\Carbon\Carbon::parse($meeting->meeting_date)->isoFormat('dddd, D MMMM YYYY')); ?>
...
</html><?php /**PATH D:\Xampp\htdocs\rapat\proyek-absensi\resources\views/public/meetings/index.blade.php ENDPATH**/ ?>