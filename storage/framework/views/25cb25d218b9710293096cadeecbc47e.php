...
<head>
    ...
    <title>Absensi Rapat: <?php echo e($meeting->title); ?></title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-2xl p-8 space-y-6 bg-white rounded-lg shadow-md">
        <div class="text-center">
            ...
            <p class="mt-2 text-lg text-gray-700"><?php echo e($meeting->title); ?></p>
            <p class="text-sm text-gray-500"><?php echo e(\Carbon\Carbon::parse($meeting->meeting_date)->isoFormat('D MMMM YYYY')); ?></p>
        </div>
        ...
        <form action="<?php echo e(route('attendance.store')); ?>" method="POST" id="attendance-form">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-2 grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-2">
                        ...
                        <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center">
                                <input type="radio" name="position" id="pos-<?php echo e(str_replace('.', '', $position)); ?>" value="<?php echo e($position); ?>" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 position-radio" required>
                                <label for="pos-<?php echo e(str_replace('.', '', $position)); ?>" class="ml-3 block text-sm font-medium text-gray-700"><?php echo e($position); ?></label>
                            </div>
...
</html><?php /**PATH D:\Xampp\htdocs\rapat\proyek-absensi\resources\views/attendance_form.blade.php ENDPATH**/ ?>